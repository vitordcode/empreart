...
export default function Header() {
  return (
    <>
      ...
      <img src={iconRight} className="absolute right-0 top-[60vh] lg:top-[40vh] lg:w-56 -z-10" alt="SVG de background" />
      <img src={iconTop} className="absolute left-0 top-[10vh] lg:top-[5vh] lg:w-48 -z-10" alt="SVG de background" />
      <img src={bolinhasLeft} className="absolute left-0 top-[40vh] lg:top-[50vh] lg:w-48 -z-10" alt="SVG de background" />
      ...
      <div className="max-w-xl relative">
        <img src={lines} className="absolute left-28 top-[-42px] w-28 lg:top-[-12rem] lg:w-48 -z-10" alt="Linhas de fundo" />
        ...
        <img src={lines} className="absolute right-28 lg:left-48 lg:bottom-[-10rem] w-32 lg:w-48 -z-10" alt="SVG de background" />
      </div>
    </section>
    </>
  )
